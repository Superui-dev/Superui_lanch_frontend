...
const MfaEnroll = () => {
  ...
  return (
    <div className="h-screen bg-neutral-0 flex flex-col justify-center py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[800px] h-[400px] bg-gradient-to-r from-secondary-500/10 via-brand-500/5 to-secondary-500/10 blur-[100px] pointer-events-none animate-gradient"></div>
